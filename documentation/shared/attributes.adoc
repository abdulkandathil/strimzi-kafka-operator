...
:DockerZookeeper: tuanhoang1/operator:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafkaImageCurrent: tuanhoang1/operator:{DockerTag}-kafka-{KafkaVersionHigher}
:DockerKafkaImagePrevious: tuanhoang1/operator:{DockerTag}-kafka-{KafkaVersionLower}
:DockerKafka: tuanhoang1/operator:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafkaConnect: tuanhoang1/operator:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafkaConnectS2I: tuanhoang1/operator:{DockerTag}-kafka-{DefaultKafkaVersion}
...
:DockerEntityOperatorStunnel: tuanhoang1/operator:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafkaBridge: tuanhoang1/operator-bridge:{BridgeDockerTag}
